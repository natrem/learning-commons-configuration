...
public class ConcreteOutputATest {
    ...
    public void setUp() throws Exception {
        ...
        configuration.addProperty("name", "concreteA");
        configuration.addProperty("url", "somewhere");
    ...
    public void should_contains_configured_properties() throws Exception {
        ...
        assertTrue(configured_output.getKeys().contains("url"));
    }
